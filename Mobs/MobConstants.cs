...
public static class MobConstants 
{
    ...
    //  Paths 
    public const string MobScenePath = "res://Mobs/Scenes/MobScene/Mob.tscn";
    private const string GenderNormsPath = "res://Assets/Mobs/Constants/GenderNorms.json";
    private const string TypeNormsPath = "res://Assets/Mobs/Constants/TypeNorms.json";
    private const string RaceNormsPath = "res://Assets/Mobs/Constants/RaceNorms.json";
    private const string MobNamesPath = "res://Assets/Mobs/Constants/MobNames.json";
    ...
    public static  readonly IReadOnlyDictionary<string, MobMeshInfo> BodyMeshesInfo = new Dictionary<string, MobMeshInfo>
        {
            ["Head"] = new("HeadMesh", "res://Assets/Mobs/Meshes/Body/Head/", new Dictionary<int, IReadOnlyList<Color>> { [0] = SkinColors }, HeadShapes),
            ["Eyes"] = new("EyeMesh", "res://Assets/Mobs/Meshes/Body/Eyes/", DefaultEyeColors),
            ["Eyelashes"] = new("LashesMesh", "res://Assets/Mobs/Meshes/Body/Eyelashes/", DefaultLashColors, LashShapes),
            ["Hair"] = new("HairMesh", "res://Assets/Mobs/Meshes/Body/Hair/", new Dictionary<int, IReadOnlyList<Color>> { [0] = HairColors }),
            ["Beard"] = new("BeardMesh", "res://Assets/Mobs/Meshes/Body/Beard/", null, BeardShapes),
            ["Brows"] = new("BrowMesh", "res://Assets/Mobs/Meshes/Body/Brows/", null, BrowShapes) 
        };

    public static readonly IReadOnlyDictionary<string, MobMeshInfo> EqMeshesInfo = new Dictionary<string, MobMeshInfo>
        {
            ["Top"] = new("TopMesh", "res://Assets/Mobs/Meshes/Equipment/Top/", new Dictionary<int, IReadOnlyList<Color>> { [0] = SkinColors, [1] = ClothesColors }, BodyShapes),
            ["Bottom"] = new("BottomMesh", "res://Assets/Mobs/Meshes/Equipment/Bottom/", new Dictionary<int, IReadOnlyList<Color>> { [0] = SkinColors, [1] = ClothesColors }, BodyShapes),
            ["Shoes"] = new("ShoeMesh", "res://Assets/Mobs/Meshes/Equipment/Shoes/", new Dictionary<int, IReadOnlyList<Color>> { [0] = ClothesColors }),
            ["Hat"] = new("HatMesh", "res://Assets/Mobs/Meshes/Equipment/Hat/", new Dictionary<int, IReadOnlyList<Color>> { [0] = ClothesColors }),
            ["Right Hand"] = new("RHandMesh", "res://Assets/Mobs/Meshes/Equipment/Rhand/"),
            ["Left Hand"] = new("LHandMesh", "res://Assets/Mobs/Meshes/Equipment/Lhand/"),
            ["Accessory"] = new("AccessoryMesh", "res://Assets/Mobs/Meshes/Equipment/Accessory/"),
        };
