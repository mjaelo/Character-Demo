...
public static class MobDataGetter
{
    ...
    public static BodyData GetRandomBodyData(List<NormInfo> norms, BodyData? bodyData = null)
    {
        ...
        foreach (var (meshName, meshInfo) in MobConstants.BodyMeshesInfo)
        {
            ...
            MobDataSetter.SetDataToBodyDataField(bodyData, meshInfo.FieldName, GetRandomMeshData(meshName, meshInfo, meshNorms));
        }
    ...
    public static EquipmentData GetRandomEquipmentData(List<NormInfo> norms, EquipmentData? eqData = null, Color? skinColor = null)
    {
        ...
        foreach (var (meshName, meshInfo) in MobConstants.EqMeshesInfo)
        {
            ...
            MobDataSetter.SetDataToEqDataField(eqData, meshInfo.FieldName, GetRandomMeshData(meshName, meshInfo, meshNorms));
        }
