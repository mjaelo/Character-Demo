...
public static class UiConstants
{
    ...
    // camera
    public const float CreatorCameraSensitivity = 2f;
    public const float GameCameraSensitivity = 5f;
    public const float CameraMaxHeight = 10.0f;
    public const float CreatorCameraZoomOffset = 2.0f;
    ...
    public static readonly IReadOnlyDictionary<string, MeshPickerInfo[]> CreatorMenuData = FileService.LoadJson<Dictionary<string, MeshPickerInfo[]>>(CreatorMenuDataPath) ?? new Dictionary<string, MeshPickerInfo[]>();
}
